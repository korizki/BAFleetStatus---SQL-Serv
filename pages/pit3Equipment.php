                ...
                while($rowshovel = $queryshovel->fetch(PDO::FETCH_ASSOC)){
                    ?>
                        <div class="boxdetailshovel coalsummary" style=" justify-content: space-around">
                            ...
                            <div class="setUnit">
                                <p style="width: 100px; text-align:center"><?php echo (getFleet($rowshovel['unit_name'], 'Kamaz')->fetchColumn(2) == 0)? "" : getFleet($rowshovel['unit_name'], 'Kamaz')->fetchColumn(2)." Kamaz"; ?> </p>
                                <p style="width: 100px"><?php echo (getFleet($rowshovel['unit_name'], 'Power Plus')->fetchColumn(2) == 0) ? "" : getFleet($rowshovel['unit_name'], 'Power Plus')->fetchColumn(2)." Power Plus"; ?></p>
                                <p style="width: 100px; text-align:center"><?php echo (getFleet($rowshovel['unit_name'], 'Hino')->fetchColumn(2) == 0)? "" : getFleet($rowshovel['unit_name'], 'Hino')->fetchColumn(2)." Hino"; ?> </p>
                                <p style="width: 100px"><?php echo (getFleet($rowshovel['unit_name'], 'SKT')->fetchColumn(2) == 0) ? "" : getFleet($rowshovel['unit_name'], 'SKT')->fetchColumn(2)." SKT"; ?></p>
                                <p style="width: 100px"><?php echo (getFleet($rowshovel['unit_name'], 'Sany')->fetchColumn(2) == 0) ? "" : getFleet($rowshovel['unit_name'], 'Sany')->fetchColumn(2)." Sany"; ?></p>
                            </div>
